...
interface OrcamentoFormProps {
  ...
  onMaterialChange: (materialNome: string, quantidade: number) => void;
...
export const OrcamentoForm: React.FC<OrcamentoFormProps> = (props) => {
  ...
  const molduraObj = useMemo(
    () => moldurasList.find((m) => m.nome === molduraSelecionada),
  ...
  return (
    <div className="form-section-wrapper">
        ...
        <div className="form-grid-3">
          ...
          <div className="form-group" style={{ marginTop: '1rem' }}>
            ...
            <input
              ...
              placeholder="Ex: cartão, Pix ou à vista"/>
          </div>
      ...
      <section className="card form-card" style={{ marginTop: '1.5rem' }}>
          ...
          <div
            ...
            {molduraObj ? (
              <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                <div
                  ...
                  {molduraObj.imagem_url ? (
                    ...
                    <ImageIcon size={24} style={{ color: 'var(--color-text)', opacity: 0.5 }} />
                  )}
                </div>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: '0.9rem', color: 'var(--color-text)', opacity: 0.7 }}>
                    {molduraObj.codigo}
                  </div>
                  <div style={{ color: 'var(--color-primary)', fontWeight: 'bold' }}>
                    R$ {parseFloat(molduraObj.valor_metro_linear.toString()).toFixed(2)}/m
                  </div>
                </div>
              ...
              <div style={{ textAlign: 'center', padding: '1.5rem' }}>
                <p style={{ color: 'var(--color-text)', opacity: 0.6, marginBottom: '1rem' }}>
                  Nenhuma moldura selecionada
                </p>
                <button className="btn btn-primary" onClick={() => setIsSelectorOpen(true)}>
        ...
        <div className="form-group">
          ...
          <div
            ...
            {materiaisList.map((material) => {
              const qtd = materiaisDoQuadro[material.nome] || 0;
              return (
                <div
                  key={material.id}
                  style={{
        ...
        <div className="form-group">
          ...
          <small style={{ color: 'var(--color-text-secondary)', fontSize: '0.8rem' }}>
            Aumenta a área de cálculo sem alterar a medida nominal.
          </small>
        </div>
        ...
        <div className="form-group" style={{ marginTop: '1.5rem' }}>
          ...
          <small style={{ color: 'var(--color-text-secondary)', fontSize: '0.8rem' }}>
            Adicione múltiplos quadros com as mesmas especificações de uma vez.
          </small>
        </div>
        ...
        <div className="form-actions" style={{ display: 'flex', gap: '1rem', marginTop: '1.5rem' }}>
          <button className="btn btn-secondary" onClick={onLimparCampos} style={{ flex: 1 }}>
            Limpar
          </button>
          <button className="btn btn-success" onClick={onAdicionarQuadro} style={{ flex: 1 }}>
      ...
      <MolduraSelectorModal
        ...
        onSelect={(m) => {
          onMolduraSelecionadaChange(m.nome);
